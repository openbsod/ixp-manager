...
return [
    ...
    */
    ...
    'backend' => explode( '|', env( 'GRAPHER_BACKENDS', 'mrtg|sflow' ) ),
    ...
    */
    ...
    'backends' => [
        ...
        'sflow' => [
            ...
            'enabled' => env( 'GRAPHER_BACKEND_SFLOW_ENABLED', true ),

            // for larger IXPs, it's quite intensive to display all the graphs
            'show_graphs_on_index_page' => env( 'GRAPHER_BACKEND_SFLOW_SHOW_ON_INDEX', true ),

            // where to find the MRTG rrd files
            'root'  => env( 'GRAPHER_BACKEND_SFLOW_ROOT', '/tmp' ),
        ]
